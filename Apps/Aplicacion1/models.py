...
class inventario(models.Model):
	...
	def __str__(self):
		return '%s %s %s ' % (self.codigo_inventario,self.nombre_inventario,self.marca_invetario)
...
class empleado(models.Model):
	...
	def __str__(self):
		return '%s %s' % (self.codigo_empleado,self.nombre_empleado)
...
class venta(models.Model):
	...
	def __str__(self):
		return '%s %s ' % (self.codigo_empleado,self.codigo_venta)
